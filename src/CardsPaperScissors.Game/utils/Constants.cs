namespace CardsPaperScissors.Game.Utils;

public static class Constants
{
    public const string DeckKey = "deck";
    public const string MatchScene = "res://scenes/match/match.tscn";
    ...
    public const string PointModel = "res://ui/matchInfo/point.tscn";
    public const int CardGap = 100;
}